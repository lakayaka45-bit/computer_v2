...
const LoginForm = ({ initialAdminMode = false }: LoginFormProps) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!isAdminMode && !isValidEmailAddressFormat(email)) {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[#f7fdf4]">
          ...
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12 border border-[#d9f5d0]">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                >
                  {isAdminMode ? "Admin username" : "Email address"}
                </label>
                <div className="mt-2">
                  <input
                    id="email"
              ...
              <div>
                <CustomButton
                  buttonType="submit"
                  text={isAdminMode ? "Enter admin panel" : "Sign in"}
                  paddingX={3}
                  paddingY={1.5}
                  customWidth="full"
                  textSize="sm"
