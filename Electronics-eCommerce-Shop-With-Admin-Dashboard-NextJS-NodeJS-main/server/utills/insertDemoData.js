...
async function insertDemoData() {
  ...
  console.log("Demo merchant inserted or already exists.");

  await prisma.category.createMany({
    data: demoCategories,
    skipDuplicates: true,
  });
  console.log("Demo categories inserted or already exist.");

  await prisma.product.createMany({
    data: demoProducts,
    skipDuplicates: true,
  });
  console.log("Demo products inserted or already exist.");
}
